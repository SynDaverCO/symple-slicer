...
class SettingsUI {
    ...
    static _input(container, id, type, attr) {
        ...
        if(attr && attr.hasOwnProperty("onclick"))       input_attr.onclick = attr.onclick;
        if(attr && attr.hasOwnProperty("step"))          input_attr.step    = attr.step;
        if(attr && attr.hasOwnProperty("default_value")) input_attr.value   = attr.default_value.toString();
