...
class SettingsUI {
    constructor(elementId) {
        ...
        var header         = SettingsUI.addTag(this.ui, "div");
     ...
     *   SettingsUI.get(attr.id + "_drophandler")
     *
     * To retrieve file contents and clear, call:
     *   SettingsUI.get(attr.id + "_clear")
     *
     */
    file(description, attr) {
        ...
        this.getters[attr.id + "_drophandler"] = function() {
            return readSingleFile
        }
        this.getters[attr.id + "_clear"] = function() {
            clearFileSelection();
            return fileContents;
        }
                ...
                switch(mode) {
                    ...
                    case "binary":
                        ...
                        r.onload = function(e) {
                            ...
                            if (attr && attr.onchange) {
                                attr.onchange(fileContents, f.name);
                            }
                        }
