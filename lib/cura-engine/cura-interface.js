...
function SlicerInterface(path) {
    ...
    this.onProgress     = function(progress) {console.log("Slicing progress:", progress);};
    this.onPrintStats   = function(stats)    {console.log("Print statistics:", stats);};
    ...
    function messageHandler(e) {
        ...
        switch (data.cmd) {
            ...
            case 'file':
                ...
                break;
             case 'progress':
                me.onProgress(data.value);
                break;
             case 'stats':
                me.onPrintStats(data.stats);
                break;
            default:
