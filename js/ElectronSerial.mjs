...
import { BOSSA } from '../lib/flashing-tools/bossa/bossa.js';
...
window.SympleSlicer = {
    flashArchimFirmware: () => {flashArchimFirmware();}
};
...
/*contextBridge.exposeInMainWorld(
  'SympleSlicer',
  {
    flashArchimFirmware: progressFunc => {flashArchimFirmware(progressFunc);}
    getByte: () => {return new Promise((resolve, reject) => {resolve();});}
  }
)*/